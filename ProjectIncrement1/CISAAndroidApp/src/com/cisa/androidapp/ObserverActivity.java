...
import com.cisa.androidapp.callback.MyPictureCallback;
import com.cisa.androidapp.services.GeoLocationService;
import com.cisa.androidapp.services.HttpAsyncService;
import com.cisa.androidapp.utils.Utils;
import com.cisa.androidapp.views.Preview;
...
public class ObserverActivity extends Activity {
	...
	public void uploadData(View v) {
		if (scene != null) {
			...
			Region reg = new Region(9, b);
			ArrayList<Region> al = new ArrayList<Region>();
			al.add(reg);
			al.add(new Region(2, b));
...
*/			
			...
			AsyncTask<String, Void, String> a = new HttpAsyncService(ObserverActivity.this).execute(String.valueOf(Utils.UploadInfo),
					Utils.UPLOAD_URL, gson.toJson(scene));
			try {
